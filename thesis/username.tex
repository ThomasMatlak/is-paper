...
One subtopic of this area of is the automated creation of pleasing melodies.
...
Genetic algorithms have been used extensively in previous research, but this paper proposes the use of a long short-term memory artificial neural network to act as a surrogate fitness function, rather than defining a set of rules and penalties for breaking those rules.
\end{abstract}
...
\input{chapters/mathBehindMusic}
\input{chapters/markovMelody}
\input{chapters/geneticAlgos}
