...
\begin{figure}[h]
	\centering
	\includegraphics{figures/overview_flowchart.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{figures/markov_flowchart.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{figures/lstm_flowchart.png}
...
Because standard MIDI values range from $0$ to $127$, we can \textit{one-hot encode} the pitch as an array of zeros with a $1$ at the index of the MIDI number we want to represent.
% TODO define one-hot-encoding
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{figures/genetic_algorithm_flowchart.png}
