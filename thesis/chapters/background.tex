...
To enable harmonic progression, notes in the melody should generally fit into the notes of some chords based on the scale of the key of the piece.
On its own this rule does not mean much, but we generally want a melody to end on the tonic chord.
Thus the last note in the melody should be the tonic, the third note of the scale, or the fifth note of the scale, and the notes leading up to the last note should provide a smooth transition to the final note.
The leading tone should always be followed by the tonic.
...
% TODO insert figure of basic ann
...
% TODO insert figure of some activtaion functions
